  ...
  */
  ...
  static async load(input) {
    ...
    if (input instanceof Uint8Array) {
      binary2 = input;
    } else if ((_a10 = globalThis.process) == null ? void 0 : _a10.versions.node) {
      const fs2 = await import("./promises-6WYLVHRL.js");
...
${JSON.stringify(symbolNames, null, 2)}`);
    ...
    return new _a6(INTERNAL, languageAddress);
  }
}, __name(_a6, "Language"), _a6);
async function Module2(moduleArg = {}) {
  ...
  var ENVIRONMENT_IS_NODE = typeof process == "object" && ((_a10 = process.versions) == null ? void 0 : _a10.node) && process.type != "renderer";
  ...
  function abort(what) {
    var _a11;
    (_a11 = Module["onAbort"]) == null ? void 0 : _a11.call(Module, what);
    what = "Aborted(" + what + ")";
    err(what);
    ABORT = true;
  ...
  var LE_HEAP_LOAD_I64 = __name((byteOffset) => HEAP_DATA_VIEW.getBigInt64(byteOffset, true), "LE_HEAP_LOAD_I64");
  ...
  var LE_HEAP_STORE_I64 = __name((byteOffset, value) => HEAP_DATA_VIEW.setBigInt64(byteOffset, value, true), "LE_HEAP_STORE_I64");
  ...
  var onPostRuns = [];
  var addOnPostRun = __name((cb) => onPostRuns.push(cb), "addOnPostRun");
  var onPreRuns = [];
  var addOnPreRun = __name((cb) => onPreRuns.push(cb), "addOnPreRun");
  var UTF8Decoder = typeof TextDecoder != "undefined" ? new TextDecoder() : void 0;
  var findStringEnd = __name((heapOrArray, idx, maxBytesToRead, ignoreNul) => {
    var maxIdx = idx + maxBytesToRead;
    if (ignoreNul) return maxIdx;
    while (heapOrArray[idx] && !(idx >= maxIdx)) ++idx;
    return idx;
  }, "findStringEnd");
  var UTF8ArrayToString = __name((heapOrArray, idx = 0, maxBytesToRead, ignoreNul) => {
  ...
  var uleb128EncodeWithLen = __name((arr) => {
    const n = arr.length;
  ...
  var generateTypePack = __name((types) => uleb128EncodeWithLen(Array.from(types, (type) => {
  ...
  var dynCall = __name((sig, ptr, args2 = [], promising = false) => {
  ...
  var onPostCtors = [];
  var addOnPostCtor = __name((cb) => onPostCtors.push(cb), "addOnPostCtor");
  var UTF8ToString = __name((ptr, maxBytesToRead, ignoreNul) => ptr ? UTF8ArrayToString(HEAPU8, ptr, maxBytesToRead, ignoreNul) : "", "UTF8ToString");
  ...
  var removeRunDependency = __name((id) => {
    var _a11;
    runDependencies--;
    (_a11 = Module["monitorRunDependencies"]) == null ? void 0 : _a11.call(Module, runDependencies);
  ...
  var addRunDependency = __name((id) => {
    var _a11;
    runDependencies++;
    (_a11 = Module["monitorRunDependencies"]) == null ? void 0 : _a11.call(Module, runDependencies);
  }, "addRunDependency");
  var loadDylibs = __name(async () => {
  ...
  var _proc_exit = __name((code) => {
    ...
    EXITSTATUS = code;
    if (!keepRuntimeAlive()) {
      (_a11 = Module["onExit"]) == null ? void 0 : _a11.call(Module, code);
      ABORT = true;
    }
  ...
  function run(args2 = arguments_) {
    ...
    function doRun() {
      ...
      (_a11 = Module["onRuntimeInitialized"]) == null ? void 0 : _a11.call(Module);
...
async function initializeBinding(moduleOptions) {
  return Module3 ?? (Module3 = await web_tree_sitter_default(moduleOptions));
}
...
var _a8;
var QueryError = (_a8 = class extends Error {
  constructor(kind, info2, index, length) {
    super(_a8.formatMessage(kind, info2));
    this.kind = kind;
    this.info = info2;
    this.index = index;
    this.length = length;
...
function parseIsPredicate(steps, index, operator, assertedProperties, refutedProperties) {
  ...
  properties[index][steps[1].value] = ((_a10 = steps[2]) == null ? void 0 : _a10.value) ?? null;
}
...
function parseSetDirective(steps, index, setProperties) {
  ...
  setProperties[index][steps[1].value] = ((_a10 = steps[2]) == null ? void 0 : _a10.value) ?? null;
}
...
var Query = (_a9 = class {
  ...
  constructor(language, source) {
    ...
    if (!address) {
      ...
      const word = ((_a10 = suffix.match(QUERY_WORD_REGEX)) == null ? void 0 : _a10[0]) ?? "";
